...
#create new dataframes to run the summary off of, one for the data points where income could be verified, 
#and one for data poins where it could not
